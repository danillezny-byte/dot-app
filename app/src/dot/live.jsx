...
window.live = {
  ...
  async createSmartInbox() {
    ...
    const blocks = [
      { id: 'b1', type: 'text', content: 'Это Инбокс — место, куда падает всё, что хочется записать, но раскладывать пока лень. Как почтовый ящик, только для мыслей: ссылки, идеи, конспекты, цитаты.' },

      { id: 'b2', type: 'heading', content: 'Как устроена База' },
      { id: 'b3', type: 'text', content: 'База — твой личный архив всего. Внутри неё лежат пространства — большие папки вроде «Работа», «Учёба», «Личное». Этот «Инбокс» — одно из таких пространств, для всего без категории. Их можно создавать сколько нужно.' },
      { id: 'b4', type: 'text', content: 'Внутри пространства — страницы (вот как эта). А внутри страницы — блоки: текст, заголовки, чек-листы, картинки, ссылки. Чтобы вставить блок, нажми «/» в начале любой строки — появится меню.' },

      { id: 'b5', type: 'heading', content: 'Что попробовать' },
      { id: 'b6', type: 'check', content: 'Создать первую задачу — вкладка Задачи, кнопка «+» внизу', checked: false },
